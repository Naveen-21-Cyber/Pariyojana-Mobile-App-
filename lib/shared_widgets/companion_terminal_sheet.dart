...
class _CompanionTerminalSheetState extends ConsumerState<CompanionTerminalSheet> {
  ...
  void _initTerminalLogs() {
    ...
    _logs.add(_TerminalLogEntry('  PARIYOJANA CYBER COMMAND TERMINAL v1.0.0      ', LogType.success));
    ...
    switch (action) {
      ...
      case 'version':
        setState(() {
          ...
          _logs.add(_TerminalLogEntry('  App Version : 1.0.0 (Production Release)', LogType.system));
